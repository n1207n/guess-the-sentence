...
export default {
  ...
  plugins: [
    new webpack.DefinePlugin({
      ...
      // Load your SECRET DATA from your .env file
      'process.env.SECRET_VALUE': JSON.stringify(process.env.process.env.SECRET_VALUE),
      'process.env.SECRET_VALUE2': JSON.stringify(process.env.process.env.SECRET_VALUE2),
      __DEV__: true
    }),
